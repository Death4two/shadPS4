...
void RegisterLib(Core::Loader::SymbolsResolver* sym) {
    // Use effective resolution which adapts for XeSS quality mode if enabled
    driver = std::make_unique<VideoOutDriver>(Config::getEffectiveInternalWidth(),
                                              Config::getEffectiveInternalHeight());
